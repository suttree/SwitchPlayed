ActionController::Routing::Routes.draw do |map|
  ...
  map.how_to_play '/faq', :controller => 'site', :action => 'faq'
  map.admin '/admin', :controller => 'site', :action => 'admin'
  
# Just for testing out the two play pages
map.connect '/play/:id/test', :controller => 'play', :action => 'test'
